...
export default function LoginPage() {
  ...
  async function handleGoogleLogin() {
    ...
    try {
      ...
      if (oauthError) {
        setError(oauthError.message || "Google sign-in failed. Subukan ulit.");
        setGoogleLoading(false);
      }
    } catch {
      setError("Hindi ma-connect sa Google. Subukan ulit.");
      setGoogleLoading(false);
    }
  }
          ...
          {step === "role" && (
            <div className="space-y-6 animate-in fade-in">
              ...
              <div className="grid grid-cols-1 gap-4">
                {/* Homeowner Card — Google OAuth */}
                <button
                  type="button"
                  onClick={handleGoogleLogin}
                  disabled={googleLoading}
                  className="card-kumpuni p-6 text-left group hover:border-kumpuni-blue hover:shadow-md transition-all duration-200 cursor-pointer disabled:opacity-70"
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-text-secondary leading-relaxed">
                        May kailangang ayusin sa bahay? Mag-sign in gamit ang Google account.
                      </p>
                    </div>
                  ...
                  <div className="mt-3 pt-3 border-t border-border-dim flex items-center justify-center gap-2 text-sm font-semibold text-text-secondary">
